...
},{}],"EK2clD":[function(require,module,exports){
var api, auth, aye, config, defs, guid, json, link, prepare_message, queue, request;
...
api.response = function(message) {
  ...
  if (a.t === 't') {
    ...
    if (data.error && data.error === 'invalid_grant') {
      ...
      return auth(false).then(ok, (function() {
...
},{"../auth/index":"MO2QCC","../config":"5pmc81","../utils/guid":"lG2o4c","../utils/queue":"jk4kKz","./..\\..\\..\\bower\\aye\\ayepromise.js":1,"./request":"k2/rex","json3":4}],"api/index":[function(require,module,exports){
module.exports=require('EK2clD');
},{}],"api/request":[function(require,module,exports){
module.exports=require('k2/rex');
},{}],"k2/rex":[function(require,module,exports){
...
},{"./..\\..\\..\\bower\\uxhr\\uxhr.js":3,"json3":4}],"qeKVBy":[function(require,module,exports){
...
module.exports=require('qeKVBy');
},{}],"auth/index":[function(require,module,exports){
module.exports=require('MO2QCC');
},{}],"MO2QCC":[function(require,module,exports){
var app, auth, aye, config, guid, iframe, link, popup, url;
...
auth.connect = function(response) {
  ...
  if (data && data.access_token && data.refresh_token) {
    ...
    return link.deffered.resolve("was ok");
  } else {
    return link.deffered.reject("auth fail");
  }
};
...
},{"../api/index":"EK2clD","../config":"5pmc81","../utils/guid":"lG2o4c","./..\\..\\..\\bower\\aye\\ayepromise.js":1,"./iframe":"qeKVBy","./popup":"oj7iyi"}],"auth/popup":[function(require,module,exports){
module.exports=require('oj7iyi');
},{}],"oj7iyi":[function(require,module,exports){
...
},{"../utils/guid":"lG2o4c","./..\\..\\..\\bower\\aye\\ayepromise.js":1}],"config":[function(require,module,exports){
module.exports=require('5pmc81');
},{}],"5pmc81":[function(require,module,exports){
...
},{"./detect/parse":"v4eahp"}],"detect/index":[function(require,module,exports){
module.exports=require('U7G3yM');
},{}],"U7G3yM":[function(require,module,exports){
...
},{"./parse":"v4eahp","json3":4}],"detect/parse":[function(require,module,exports){
module.exports=require('v4eahp');
},{}],"v4eahp":[function(require,module,exports){
var parse;
...
module.exports=require('dL0SgJ');
},{}],"dL0SgJ":[function(require,module,exports){
var Root, api, aye, config, css, event, steps;

css = "#blogvio-root{position:absolute;top:-1000px;left:-1000px;width:0px;height:0px;visibility:hidden;z-index:-1}#blogvio-root iframe{width:0px;height:0px}";
...
},{"../api/index":"EK2clD","../config":"5pmc81","../utils/event":"Z7w9hd","./..\\..\\..\\bower\\aye\\ayepromise.js":1}],"index":[function(require,module,exports){
module.exports=require('sgsSMt');
},{}],"sgsSMt":[function(require,module,exports){
var Blogvio, JSON, Root, api, auth, chain, detect, event, receiver, receivers, win;
...
receiver = function(e) {
  ...
  d = e.data;
  try {
    return typeof receivers[_name = (d = JSON.parse(d)).t] === "function" ? receivers[_name](d) : void 0;
  } catch (_error) {}
};

chain = function(promise) {
  promise.api = this.api;
  promise.login = this.login;
  return promise;
};
...
Blogvio = function() {
  ...
  return detect(win.location.href);
};
...
Blogvio.prototype.init = function(client_id, redirect_uri) {
  ...
  (this.root = new Root()).createProxy();
  auth.setAuthOptions(client_id, redirect_uri, this.root);
  return this;
};

Blogvio.prototype.api = function() {
  return chain.apply(this, [api.apply(this, arguments)]);
};

Blogvio.prototype.auth = function() {
  return chain.apply(this, [auth.apply(this, arguments)]);
};
...
},{"./..\\..\\bower\\aye\\ayepromise.js":1,"./api":"EK2clD","./auth":"MO2QCC","./detect":"U7G3yM","./dom/root":"dL0SgJ","./utils/event":"Z7w9hd","./utils/guid":"lG2o4c","json3":4}],"utils/event":[function(require,module,exports){
module.exports=require('Z7w9hd');
},{}],"Z7w9hd":[function(require,module,exports){
var add, rem;
...
module.exports=require('lG2o4c');
},{}],"lG2o4c":[function(require,module,exports){
var guid;
...
module.exports=require('jk4kKz');
},{}],"jk4kKz":[function(require,module,exports){
...
},{"./..\\..\\..\\bower\\queue-async\\queue.js":2}],31:[function(require,module,exports){
var BSDK;
