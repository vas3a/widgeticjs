...
resizeHolderTemplate = function(id, styles, forIframeEmbed) {
  if (forIframeEmbed) {
    return ("<div style=\"width:100%;" + (styles.wrapStyle || '') + "\">") + ("<div style=\"position:relative; padding: 0;" + (styles.holdStyle || '') + "\">") + "$$$" + "</div>" + "</div>";
  } else {
...
parse.wrapperHtml = function(options, forIframeEmbed) {
  ...
  return resizeHolderTemplate(options.composition, styles, forIframeEmbed);
};
...
Widgetic.prototype.VERSION = '0.5.13';
