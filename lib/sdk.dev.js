...
},{"./composition":"vLZnBx","./editor":"4teAgo","./parse":"ga8u34","./popup":"2x7f1H"}],"ga8u34":[function(require,module,exports){
...
},{}],"2x7f1H":[function(require,module,exports){
...
},{"./../../../../bower/aye/ayepromise.js":1,"config":"w4N2lO","json3":5,"utils/event":"1DYCdS","utils/guid":"wdlc5X"}],"api/index":[function(require,module,exports){
...
auth.connect = function(response) {
  var data;
  data = response.d;
  setTimeout(auth.bind(this, false), data.expires_in * 1000 - 1500);
...
Blogvio.prototype.VERSION = '0.4.5';
