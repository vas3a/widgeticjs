...
},{"./../../../../bower/queue-async/queue.js":3,"config":"8XITP5","utils/guid":"UGrkyH"}],"UI/editor/index":[function(require,module,exports){
...
},{"./composition":"jnQQj6","./editor":"ufPusa","./parse":"tja8Yy","./popup":"0CZ5TN"}],"UI/parse":[function(require,module,exports){
module.exports=require('tja8Yy');
},{}],"tja8Yy":[function(require,module,exports){
...
},{"../utils/ready":"HTcrDo"}],"UI/popup/index":[function(require,module,exports){
module.exports=require('0CZ5TN');
},{}],"0CZ5TN":[function(require,module,exports){
var Popup, ackMessage, aye, config, debounce, defs, event, extend, getOffset, guid, json, loadSheet, newMessage, replyMessage, send, ucfirst,
...
Popup = (function() {
  ...
  Popup.onCreate = function(message, ev) {
    ...
    iframe.doPosition = debounce(this.doPosition.bind(this, iframe, null));
  ...
  Popup.onCreateDone = function(message, event) {
    return ackMessage(message, event.source.frames[message.d.name].document);
  };
  ...
  Popup.prototype.append = function(el) {
    ...
    return this.resize().then(this.position);
  };
  ...
  Popup.prototype._prepare = function(document) {
    var sheet, styles, _i, _len, _ref;
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      sheet = _ref[_i];
      loadSheet(sheet, this.head, this.resize);
    }
    return this;
  };
...
},{"./../../../../bower/aye/ayepromise.js":1,"config":"8XITP5","json3":5,"utils/event":"hDR6Ig","utils/guid":"UGrkyH"}],"api/index":[function(require,module,exports){
...
},{"../auth/index":"yxtcLU","../config":"8XITP5","../utils/guid":"UGrkyH","../utils/queue":"yrKePh","./../../../bower/aye/ayepromise.js":1,"./../../../bower/pubsub.js/src/pubsub.js":2,"./request":"VqaOnQ","json3":5}],"VqaOnQ":[function(require,module,exports){
...
},{"../api":"FMNssa","../config":"8XITP5","./../../../bower/aye/ayepromise.js":1,"./iframe":"3Vwtb5","./popup":"09Pigf"}],"auth/popup":[function(require,module,exports){
module.exports=require('09Pigf');
},{}],"09Pigf":[function(require,module,exports){
...
},{"../utils/guid":"UGrkyH","./../../../bower/aye/ayepromise.js":1}],"config":[function(require,module,exports){
...
},{"./detect/parse":"H7Mrcz"}],"0AZ/Pn":[function(require,module,exports){
...
},{"../api/index":"FMNssa","../auth/iframe":"3Vwtb5","../config":"8XITP5","../utils/event":"hDR6Ig","./../../../bower/aye/ayepromise.js":1}],"xG1ei8":[function(require,module,exports){
...
Blogvio.prototype.VERSION = '0.3.3';
...
},{"./../../bower/aye/ayepromise.js":1,"./../../bower/pubsub.js/src/pubsub.js":2,"./UI":"Ecauda","./UI/composition":"jnQQj6","./UI/editor":"ufPusa","./api":"FMNssa","./auth":"yxtcLU","./detect":"0AZ/Pn","./dom/root":"L8S0oV","./utils/event":"hDR6Ig","./utils/guid":"UGrkyH","./utils/ready":"HTcrDo","./utils/timestamp":"Xt16AM","json3":5}],"index":[function(require,module,exports){
