...
},{}],"auth/iframe":[function(require,module,exports){
...
},{"./../../../bower/aye/ayepromise.js":1}],"auth/index":[function(require,module,exports){
...
},{"../api":"pK1+ma","../config":"ZaiTg0","./../../../bower/aye/ayepromise.js":1,"./iframe":"67urtb","./popup":"JLc0KN"}],"auth/popup":[function(require,module,exports){
...
},{"../utils/guid":"EadS8b","./../../../bower/aye/ayepromise.js":1}],"ZaiTg0":[function(require,module,exports){
...
var Composition, Editor, JSON, Root, UI, Widgetic, api, auth, aye, callReceiver, config, detect, event, hasProxy, initProxy, msgReceiver, originRegex, parseData, proxyReceiver, receivers, whenReady, win, winP;
...
callReceiver = function(e, data) {
  var isProxy, receiver, sourceName;
  try {
    sourceName = e.source.name;
  } catch (_error) {}
  if (isProxy = data.t === 'p' && (e.source === winP || Composition.getComp(data.d.source || sourceName))) {
