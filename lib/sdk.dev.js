...
var Popup, ackMessage, aye, config, debounce, defs, event, extend, getCssValue, getOffset, guid, json, loadSheet, newMessage, replyMessage, send, ucfirst,
...
Popup = (function() {
  ...
  Popup.prototype.position = function() {
    ...
    if (this.anchor.jquery) {
      anchor = this.anchor.offset();
      anchor.width = parseInt(this.anchor.outerWidth(), 10);
      anchor.height = parseInt(this.anchor.outerHeight(), 10);
  ...
  Popup.prototype._prepare = function(window) {
    var onLoad, sheet, styles, _i, _len, _ref,
      _this = this;
    this.window = window;
...
},{"./parse":"H7Mrcz","json3":5}],"detect/index":[function(require,module,exports){
...
Blogvio.prototype.VERSION = '0.3.9';
...
},{"./../../bower/aye/ayepromise.js":1,"./../../bower/pubsub.js/src/pubsub.js":2,"./UI":"Ecauda","./UI/composition":"jnQQj6","./UI/editor":"ufPusa","./api":"FMNssa","./auth":"yxtcLU","./detect":"0AZ/Pn","./dom/root":"L8S0oV","./utils/event":"hDR6Ig","./utils/guid":"UGrkyH","./utils/ready":"HTcrDo","./utils/timestamp":"Xt16AM","json3":5}],"hDR6Ig":[function(require,module,exports){
var add, rem;
