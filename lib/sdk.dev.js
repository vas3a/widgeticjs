...
},{"./../../../../bower/queue-async/queue.js":3,"config":"8XITP5","utils/guid":"UGrkyH"}],"ufPusa":[function(require,module,exports){
...
},{"./composition":"jnQQj6","./editor":"ufPusa","./parse":"tja8Yy"}],"UI/index":[function(require,module,exports){
...
embed = function(el) {
  ...
  holder = getHolder(el);
  composition = new Blogvio.UI.composition(holder, options.id);
...
Blogvio.prototype.VERSION = '0.3.0';
