...
var Popup, ackMessage, aye, clientRectToObject, config, debounce, defs, event, extend, getCssValue, getOffset, getTextFromStyleElement, guid, json, loadSheet, newMessage, replyMessage, send, ucfirst, _getInfo,
...
Popup = (function() {
  ...
  Popup.prototype._prepare = function(window) {
    var allSheetsLoaded, cloneAndAppend, loadedSheets, onLoad, sheet, sheets, styles, _i, _len, _ref,
      _this = this;
    this.window = window;
    ...
    cloneAndAppend = function(el) {
      return _this.head.appendChild(el.cloneNode());
    };
    Array.prototype.map.call(sheets, cloneAndAppend);
    if (!this.css) {
      return this;
    }
...
},{"../utils/guid":"EadS8b","./../../../bower/aye/ayepromise.js":1}],"config":[function(require,module,exports){
...
Widgetic.prototype.VERSION = '0.5.20';
