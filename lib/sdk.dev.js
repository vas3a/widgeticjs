...
Composition = function(holder, opt1, opt2) {
  var client_id, composition, options, query, token, url,
    _this = this;
  if (opt2 == null) {
    opt2 = {};
  }
  ...
  if ((options.widget_id != null) && !client_id) {
...
},{"./composition":"aP+Ks/","./editor":"sk8aR+","./parse":"RadvXf","./popup":"7FyBBT"}],"UI/parse":[function(require,module,exports){
...
},{"../utils/ready":"IiXnYl"}],"7FyBBT":[function(require,module,exports){
...
},{"../auth/index":"9joUsL","../config":"ZaiTg0","../utils/guid":"EadS8b","../utils/queue":"GkoH8v","./../../../bower/aye/ayepromise.js":1,"./../../../bower/pubsub.js/src/pubsub.js":2,"./request":"kgtKz9","json3":5}],"api/request":[function(require,module,exports){
...
},{"./../../../bower/uxhr/uxhr.js":4,"json3":5}],"67urtb":[function(require,module,exports){
...
Widgetic.prototype.VERSION = '0.4.10';
...
},{"./../../bower/aye/ayepromise.js":1,"./../../bower/pubsub.js/src/pubsub.js":2,"./UI":"4bzqDg","./UI/composition":"aP+Ks/","./UI/editor":"sk8aR+","./api":"pK1+ma","./auth":"9joUsL","./config":"ZaiTg0","./detect":"B8S8ON","./dom/root":"+aqgVi","./utils/event":"OZFmFt","./utils/guid":"EadS8b","./utils/ready":"IiXnYl","./utils/timestamp":"JpsWip","json3":5}],"index":[function(require,module,exports){
