...
Composition = function(holder, data) {
  var url,
    _this = this;
...
},{"./../../../../bower/queue-async/queue.js":3,"config":"8XITP5","utils/guid":"UGrkyH"}],"UI/composition/index":[function(require,module,exports){
...
Editor = function(holder, composition) {
  var _this = this;
...
Editor.prototype.goTo = function(step) {
  ...
  if (__indexOf.call(steps, step) < 0) {
    return console.warn("The editor does not have the " + step + " step.");
  }
  this._sendMessage({
    t: 'step',
    d: step
...
},{"../../api":"FMNssa","./../../../../bower/pubsub.js/src/pubsub.js":2,"./../../../../bower/queue-async/queue.js":3,"config":"8XITP5"}],"UI/editor/index":[function(require,module,exports){
module.exports=require('ufPusa');
},{}],"Ecauda":[function(require,module,exports){
var Composition, Editor, UI, composition, editor;
...
},{"./composition":"jnQQj6","./editor":"ufPusa"}],"UI/index":[function(require,module,exports){
...
url = function(scope) {
  ...
  return "" + config.auth + "?client_id=" + app.id + "&redirect_uri=" + app.uri + "&response_type=token&scope=" + (scope.join(' '));
};
...
detect = function(url) {
  var d, hash, hashKey, parsed, proxy, query, queryKey, t;
  ...
  proxy = hash === 'proxy';
  if (!(query || hashKey.access_token || proxy)) {
    return;
  }
  t = proxy ? 'i' : 'o';
  d = hash ? (!proxy ? hashKey : void 0) : queryKey;
...
var Blogvio, Composition, Editor, JSON, Root, api, auth, detect, event, hasProxy, initProxy, receiver, receivers, whenReady, win;
...
Blogvio.prototype.VERSION = '0.2.6';
