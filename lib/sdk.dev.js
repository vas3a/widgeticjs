...
getCssValue = function(el, property) {
  ...
  value = window.getComputedStyle(el).getPropertyCSSValue(property);
  if (!value) {
    return void 0;
  }
  value = value.cssText;
...
},{"../api/index":"FMNssa","../auth/iframe":"3Vwtb5","../config":"8XITP5","../utils/event":"hDR6Ig","./../../../bower/aye/ayepromise.js":1}],"index":[function(require,module,exports){
...
Blogvio.prototype.VERSION = '0.3.4';
